      ...
      <div className="w-full flex flex-col md:flex-row justify-between items-center md:items-start md:ml-22">
        <div className="w-full md:w-auto p-8 text-center md:text-left">
          ...
          <div className="flex justify-center md:justify-start mt-8 px-4">
            <button className="bg-[#3BAFBF] px-4 py-2 text-base font-bold text-white">
              Book a Consultation
            </button>
          </div>
        </div>
        ...
        <div className="w-full md:w-auto mt-8 md:mt-0 md:ml-8">
          <Image
            src={tempImagewju}
            alt="Logo"
            className="w-full md:w-[606px] h-[580px] mix-blend-multiply"
          />
        </div>
      </div>
      ...
      <div className="w-full">
        <div className="w-full md:w-1/2 mx-auto">
          <div className="mb-4 flex justify-center">
            <p className="font-bold text-4xl pt-4 md:pt-0 text-[20px] leading-8 md:leading-29 tracking-normal text-left">
          ...
          <div className="mb-14 p-5">
            ...
            <textarea
              name=""
              id=""
              className="border border-gray-300 w-full h-[300px] outline-none"
            ></textarea>
          </div>
        </div>
      </div>
