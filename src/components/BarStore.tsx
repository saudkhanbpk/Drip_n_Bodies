...
function SampleNextArrow(props: SliderArrowProps) {
  ...
  return (
    <div>
      <h1 className=" bg-black  absolute top-0 right-20 text-white p-2  "  onClick={onClick}>
...
function SamplePrevArrow(props: SliderArrowProps) {
  ...
  return (
    <div>
      <h2 className=" bg-[#F4B5D9]  absolute top-0 right-40 z-30 text-white p-2 " onClick={onClick}>
...
const BarStore: React.FC = () => {
  ...
  return (
    <>
      ...
      <div className=" w-full mt-24 items-center flex justify-center border-4 ">
      ...
      <div className=" mb-12 border items-center w-[1218px] flexjustify-center mx-auto">
        <p className="text-center font-montserrat text-[#3BAFBF] text-base font-bold leading-6 uppercase">
      ...
      <div className="w-full border-4 bg-no-repeat bg-[url('../images/barbg.png')] h-[500px]">
        <div className="">
          <div className="slider-container ">
            <Slider {...settings} className="mt-10">
              <div>
                <div className="gap0 p-6 border-2 border-[#F4B5D9] bg-white w-[360px] h-[305px]">
