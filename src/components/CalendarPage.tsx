...
const CalendarPage = () => {
  return (
    <>
        ...
        <div className=" w-full mt-24 items-center flex justify-center ">
          <div className="my-6items-center w-[86%] flex flex-col md:flex-row justify-center  mx-auto gap-8 lg:gap-16">
    ...
    <div className="flex flex-col items-center justify-center my-4">
        ...
        />
                ...
                <div className="px-4 border-left ">
                  <p className="text-black text-center font-Montserrat text-[24px] font-bold leading-normal">
                    After Hours:
                  </p>
                  <p className="text-black font-Montserrat text-[24px] font-normal leading-normal">
  ...
  <Image src={bar2} alt="img" className="w-full h-full" />
        ...
        <div className="w-full items-center justify-center  text-center p-2">
          <a href="" className="text-base font-bold text-[#3BAFBF]">View our Mobile Concierge Services</a>
